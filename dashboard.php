                    ...
                    <section class="section">
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <!-- NEW RISE BOX -->
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="margin-top:1%">
                                    <a class="dashboard-stat" href="rise.php" style="background:#ff4d4d; color:white;">
                                        <?php 
                                        $sql4="SELECT COUNT(*) as failedCount FROM tblresult WHERE marks < 35";
                                        $query4 = $dbh->prepare($sql4);
                                        $query4->execute();
                                        $failed=$query4->fetch(PDO::FETCH_OBJ);
                                        ?>
                                        <span class="number counter" style="font-weight:bold;"><?php echo htmlentities($failed->failedCount);?></span>
                                        <span class="name" style="font-weight:bold;">RISE</span>
