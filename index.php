...
<html lang="en">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container">
                <a class="navbar-brand" href="index.php">RISE- RISING INCOMPETENT STUDENTS EDUCATION</a>
        ...
        <header class="py-5 bg-image-full" style="background-image: url('images/img.png')">
...
<?php }} ?>
        ...
        <footer class="py-5 bg-dark">
            <div class="container"><p class="m-0 text-center text-white"> RISE </p></div>
        </footer>
        <!-- Bootstrap core JS-->
